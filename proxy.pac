//pacfile for 90.249.42.61 from 40665_19360:2_12080
function FindProxyForURL(url, host)
{
    ...
    */
    ...
    var domain_list = new Array("ce0314li.webitrent.com,webdefence.cluster-lonb.blackspider.com");
    ...
    var domain_list = new Array("salmonservicedesk.salmon.com",
"dfs-apteco.caci.co.uk",
"*linnworks*",
"dfs.local",
"n56.network-auth.com",
"connect.dfs.co.uk",
...
"rdweb.dfs.local",
"dwell.local",
"dfsstage.karmadevs.com",
"dfs.aptem.co.uk",
"java.com",
"dfs.groupanalytics.co.uk");
    for (d in domain_list)
    {
...
isInNet(hostIP, '100.64.0.0', '255.192.0.0'))
        ...
        if (isInNet(hostIP, "192.35.53.0", "255.255.255.0") ||
isInNet(hostIP, "172.19.29.32", "255.255.255.224"))
        {
            return 'DIRECT';
        }
    }
